...
addToModalBagButtons2.addEventListener("click", () => {
  ...
  const titleElement2 = document.querySelector(".product-details .detailsCard .title-price .product-title-p");
  ...
  const priceBag2 = parseInt(priceElement2.textContent);
  const titleBag2 = titleElement2.textContent.trim();
  const quantityBag2 = parseInt(quantityElement2.value);
  let sizeBag2 = "";
  ...
  const imageBag2 = imageElement2.getAttribute("src");
